...
public:
    ...
    */
    ...
    deskewFlag(0)
    {
        ...
        pubExtractedCloud = nh.advertise<sensor_msgs::PointCloud2> ("test_gtsam/deskew/cloud_deskewed", 1);
        // 发布当前激光帧运动畸变校正后的点云信息
        pubLaserCloudInfo = nh.advertise<test_gtsam::cloud_info> ("test_gtsam/deskew/cloud_info", 1);
    ...
    */
    bool cachePointCloud(const sensor_msgs::PointCloud2ConstPtr& laserCloudMsg)
    {
        ...
        // is_dense(bool) 点云数据中所有点均有值为true,有inf/NaN为false
